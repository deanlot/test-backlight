 ...
 */
export const ActionText = ({ children, variant = 'medium', uppercase = false }: ActionTextProps) => (
  <StyledActionText className={actionTextStyles({ variant, uppercase })}>{children}</StyledActionText>
);
